...
```bash
git clone https://github.com/xingyen0613/TYPUS-Report-Agent.git
cd TYPUS-Report-Agent
...
本项目共 11 个 Skills，分为数据抓取、月报流程、週报流程、发布四类。
...
└── fetch-figma-cover/
    ├── SKILL.md
    ├── generate-cover.py      # 本地封面图生成脚本
    ├── cover-base-template.png
    └── monthly-cover-base-template.png
```
