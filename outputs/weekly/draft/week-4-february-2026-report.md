...
Macro uncertainty took center stage this week as U.S.-Iran military escalation and legal challenges to Trump's tariff framework rattled broader markets — with crypto broadly selling off before staging a partial recovery. On Typus, the turbulence translated into a surge of directional activity: weekly trading volume reached ~$2.3M (+~151% WoW), driven by aggressive SUI short positioning as prices fell ~-5%. The resulting wave of liquidations (~$265k) generated strong counterparty gains for LPs, pushing mTLP to outperform simply holding SUI this week. DAU continued its steady upward trend since relaunch, and mTLP TVL grew meaningfully as more LPs entered the pool. The platform is still operating under an ongoing trading fee discount, with fee APR reaching 100%+ during peak periods — and U.S. equity trading pairs are on the horizon.
