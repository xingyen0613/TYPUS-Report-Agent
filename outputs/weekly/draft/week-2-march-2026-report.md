# Typus TLP Weekly Report | March 9, 2026

**TL;DR**

- Institutional momentum — Strategy's resumed BTC accumulation and BlackRock's digital asset ETF launch in Europe — combined with oil market volatility to fuel a broad risk-on recovery; BTC challenged ~$74k while SUI led majors with ~+16% on the week
- Platform volume surged to ~$4.8M (+135% WoW), the strongest single-week total in recent history, driven by USOIL directional flows and accelerating SUI positioning
- mTLP returned +2.68% as SUI's rally flowed through the pool's basket; iTLP-TYPUS pulled back -5.08% — an atypical move for the USDC pool, worth monitoring in the coming weeks
- Leveraged short positions cleared aggressively on Wednesday (~$240k in single-day liquidations as SUI broke higher), with traders ending the week modestly net profitable overall
- Fee Discount campaign ends **March 23** — final week to trade at reduced rates; referral system and additional U.S. equity pairs are actively in development

## Institutional Flows and Oil Volatility Fuel the Week's Biggest Volume Surge
...
## SUI's Rally Lifts mTLP; iTLP Posts an Unusual Pullback
...
## Wednesday's Liquidation Wave Clears Leveraged Positions as SUI Breaks Higher
...
## Open Interest Expands as New Pairs Draw Capital
